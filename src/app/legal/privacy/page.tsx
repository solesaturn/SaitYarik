...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Политика конфиденциальности и обработки ПДн (152-ФЗ)">
      <p>
        Оператор обрабатывает персональные данные покупателей (имя, телефон, e-mail, адрес доставки или пункта выдачи, реквизиты юрлица) в целях исполнения договоров розничной купли-продажи и оптовых поставок.
      </p>
      <p>
